...
<body class="container mt-4 min-vh-100">
    ...
    <div class="d-flex flex-row">
        ...
        <button type="button" class="btn btn-outline-dark m-1" data-bs-toggle="modal"
            data-bs-target="#exampleModal-departamentos">Agregar</button>
    ...
    <div class="modal fade" id="exampleModal-departamentos" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Agrega un Departamento</h1>
                ...
                <div class="modal-body">
                    <form action="../main/functions.php" method="post">
                        ...
                        <input type="number" name="txt_cod_depto" id="txt_cod_depto" class="form-control">

                        <label for="txt_nombre_depto">Departamento</label>
                        <input type="text" name="txt_nombre_depto" id="txt_nombre_depto" class="form-control">

                        <label for="txt_cod_region">Codigo region</label>
                        <input type="text" name="txt_cod_region" id="txt_cod_region" class="form-control">

                        <div class="d-flex justify-content-center mt-3">
                            <button type="submit" class="form-control btn btn-outline-primary w-50 "
                                name="btn_insertar_depto" id="btn_insertar_depto">Agregar Departamento</button>
                        </div>
                    </form>
                </div>
                ...
                while ($datos = mysqli_fetch_assoc($ejecutar)) {
                    ...
                    <tr>
                        ...
                        <td class="d-flex flex-row justify-content-center">
                            <form action="../ediciones/editarDepto.php" method="post">
                                <input type="hidden" name="h_codigo_editar_depto" id="h_codigo_editar_depto"
                                    value="<?php echo $datos["cod_depto"]; ?>">
                                <button type="submit" name="btn_editar_depto" id="btn_editar_depto"
                                    class="btn btn-outline-primary me-1"><i class="bi bi-pencil-square"></i></button>
                            </form>
                            <form action="../main/functions.php" method="post">
                                <input type="hidden" name="h_codigo_borrar_depto" id="h_codigo_borrar_depto"
                                    value="<?php echo $datos["cod_depto"]; ?>">
                                <button type="submit" name="btn_eliminar_depto" id="btn_eliminar_depto"
